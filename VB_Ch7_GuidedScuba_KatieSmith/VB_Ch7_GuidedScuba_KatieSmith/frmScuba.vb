' Program:  Scuba Expeditions Application
' Author:   Katie Smith
' Date:     3-26-22
' Purpose:  This program allows a customer to view scuba expeditions available in various locations
'               around the world.
...
Public Class frmScuba
    ...
    Private Sub cboLocation_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboLocation.SelectedIndexChanged
        ' This even handler allows the user to enter the location choice and then calls
        '       subprocedures to place the dive types in the list
    ...
    Private Sub btnDiveCost_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDiveCost.Click
        ' This button event handler determines the cost of scuba expeditions and displays the size
        '   of the team, the cost, and the length of the dive
    ...
    Private Function ValidateDiveSelection(ByRef blnDive As Boolean, ByRef strDive As String) As Integer
        ...
        Try
            ...
            strDive = lstDive.SelectedIndex.ToString()
            blnDive = True
        Catch Exception As SystemException
    ...
    Private Function AustraliaDiveCost(ByVal intDive As Integer, ByVal intTeam As Integer, ByRef intTime As Integer) As Decimal
        ' This function calculates the cost of hte dive team in Australia
